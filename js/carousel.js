...
VCarousel.prototype = {
    init: function(data){
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            imgListTpl += '<a data-index=' + i + ' data-url="' + data[i].url + '" class="img-item">' +
            '<img src="' + data[i].img + '"><div class="img-modal"></div>'+
            '<span class="img-tip" style="display: ' + data[i].dis + '">'+ data[i].tip +'<span class="tip-tail"></span></span></a>';
